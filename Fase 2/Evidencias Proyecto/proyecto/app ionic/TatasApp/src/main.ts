...
import { locate, calendar, people, personOutline, lockClosedOutline, arrowForwardOutline, radioButtonOn, radioButtonOff, trash, pencil, notificationsCircleOutline, personAdd, settings } from 'ionicons/icons';
